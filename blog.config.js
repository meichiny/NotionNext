...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'meichy', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || "Meichy's Blog", // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://meichy.netlify.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'notion, blog, 博客', // 网站关键词 英文逗号隔开
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,wechat,email,telegram', // 分享的服務，按顺序显示,逗号隔开
